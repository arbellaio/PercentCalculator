...
namespace PercentCalculator.Views.SubViews
{
	...
	public partial class PercentageIncrease : ContentPage
	{
	    ...
	    private void CalculatePercentageIncrease(object sender, EventArgs e)
	    {
	        if (!string.IsNullOrEmpty(Value1.Text) && !string.IsNullOrEmpty(Value2.Text))
	        {
	            ...
	            var result = FormulasHelper.Formula2(value1, value2);
